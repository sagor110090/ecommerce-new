@extends('layouts.app',['pageTitle' => __(' Category Management')])
@section('content')
...
<div class="col-md-12">
    <div class="card">
        <h6 class="card-header">{{ __(' Category List') }}</h6>

        <div class="card-body">
            @if (Helper::authCheck('category-create'))
            ...
            <div class="table-responsive mt-3">
                <table class="table table-striped table-hover" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/admin/category/' . $item->id) }}" title="View"><button
                                        class="btn btn-info btn-sm"><i class="feather-16"
                                            data-feather="eye"></i></button></a>
                                @if (Helper::authCheck('category-edit'))
                                <a href="{{ url('/admin/category/' . $item->id . '/edit') }}" title="Edit"><button
                ...
                <div class="pagination-wrapper"> {!! $category->appends(['search' => Request::get('search')])->render()
                    !!} </div>
            </div>
