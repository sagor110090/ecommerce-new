@extends('layouts.app',['pageTitle' => __(' Type Add')])
@section('content')
...
@endcomponent
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/admin/type') }}" title="Back"><button
                    ...
                    <form method="POST" id="oneTimeSubmit" action="{{ url('/admin/type') }}" accept-charset="UTF-8"
                        class="form-horizontal needs-validation" novalidate=""  enctype="multipart/form-data">
                        {{ csrf_field() }}

                        @include ('admin.type.form', ['formMode' => 'create'])
